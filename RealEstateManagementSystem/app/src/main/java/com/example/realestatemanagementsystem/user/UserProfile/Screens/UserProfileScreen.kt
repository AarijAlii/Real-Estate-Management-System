...
fun UserProfileScreen(
    ...
    // Fetch user profile from Firestore and Room
    LaunchedEffect(email) {
        profileViewModel.getUserProfileFromFirestore(email) // Fetch from Firestore
        profileViewModel.getUserProfile(email) // Fetch from Room
    }
    ...
    if (userProfile != null) {
        ...
        Column(verticalArrangement = Arrangement.Center, modifier = Modifier.padding(16.dp)) {
            ...
            Column(verticalArrangement = spacedBy(16.dp)) {
                ...
                Button(
                    onClick = {
                        // Update user profile in both Firestore and Room
